        ...
        try {
            ...
            if (
                ...
                newFileName.length() > 0 ) {
                    ...
                    System.out.println("Arquivo" + chooser.getSelectedFile().getName());
                } else {
                    System.out.println("Ops! Não foi possivel renomear o arquivo. Por favor, Verifique e tente novamente mais tarde.");
                }
        } catch (Exception e) {
            System.err.println("Não foi possível renomear o arquivo! Erro: " + e);
        }
    }
}